    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4">
      <div class="col d-flex align-items-stretch">
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title" id="cttl1">Quim som?</h5>
            <p class="card-text" id="ctxt1">Que es el centre d'estudis politecnics de Barcelona?</p>
          </div>
        </div>
      </div>
      <div class="col d-flex align-items-stretch">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text" id="ctxt2">T'ensenyem el nostre model d'ensenyament - aprenentatge.</p>
          </div>
        </div>
      </div>
      <div class="col d-flex align-items-stretch">
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title" id="cttl3">Innovació</h5>
            <p class="card-text" id="ctxt3">Innovació pedagògica al Centre d'Estudis Politècnics.</p>
          </div>
        </div>
      </div>
    </div>
