        ...
        <div class="card">
          <a href="https://politecnics.barcelona/el-centre/">
            ...
            <div class="card-body">
              ...
              <p class="card-text" id="cttl2">Que es el centre d'estudis politecnics de Barcelona?</p>
            </div>
          </a>
        </div>
      </div>
        ...
        <div class="card">
          <a href="https://politecnics.barcelona/el-centre/qualitat-al-politecnics/">
            ...
            <div class="card-body">
              ...
              <p class="card-text" id="ctxt3">Servei de compromís amb una bona acció educativa i garantia d’èxit</p>
            </div>
          </a>
        </div>
      </div>
