  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav">
        ...
        <p class="pt-2 pr-2" id="admin-icon">
          <span class="adminIcon" onclick="window.location.href = '/OpenHouseJocs/views/admin/views/login.php'">
        ...
        <li class="nav-item dropdown mx-2" id="dropdown-lang">
